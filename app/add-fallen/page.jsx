...
export default function AddFallenPage() {
    ...
    const handleChange = (e) => {
        ...
        if (name === "hobbies") {
            const hobbiesArray = value.split(",").map(hobby => hobby.trim()).filter(hobby => hobby !== "");

            if (hobbiesArray.length > 6) {
                return;
            }
        }
        ...
        <div className={styles.container}>
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
                <div className={styles.allFormDetails}>
                    ...
                    <Button type='submit' className={styles.submitButton} children={'שליחה'} />
                </div>
            </form >
            {statusMessage && (
